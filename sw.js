const CACHE='my-fishing-life-v14.6.0';
const ASSETS=['./','./index.html','./css/styles.css','./css/conditions.css','./css/realmap.css','./js/conditions.js','./js/app.js','./manifest.webmanifest',
