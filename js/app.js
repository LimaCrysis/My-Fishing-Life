...
,{id:'tateyama_sunset',area:'chiba',name:'館山夕日桟橋',short:'館山夕日桟橋',pref:'千葉',beginner:5,tackle:'◎',address:'千葉県館山市館山1564-1周辺',fish:'アジ・サバ・シロギス・クロダイ・スズキなど',styles:['サビキ ◎','ちょい投げ ◎','ヘチ釣り ○','ルアー ○'],facilities:['約500m桟橋','手すり','周辺トイレ','渚の駅たてやま'],note:'館山市公式が桟橋での釣りを案内。竿は1人2本まで。上投げ・横投げは禁止。コマセは「カゴ」に入れたもののみ使用可能。歩道側・先端部での釣りは禁止。2026年8月21日まで平日8:30〜17:00は歩道改修工事により一部立入禁止。',gear:'S90MLでサビキ・ちょい投げ・軽いルアー、100MHで少し重めの仕掛けと使い分けしやすい。',checked:'2026年8月',official:'https://www.city.tateyama.chiba.jp/minato/page100352.html'}
];
...
const seawallMapData={'urayasu_chidori':{title:'浦安・千鳥護岸',note:'釣り場の形と水際を分かりやすくしたMFL簡易模式図。入口・施設・規制は現地の最新表示を優先。',legend:['黄色＝釣り可能水際の目安', '🎣＝狙いやすい側のイメージ', '現地掲示を最優先'],svg:`<svg viewBox="0 0 760 330"><rect width="760" height="330" rx="26" fill="#d8eef2"/><path d="M40 65H520V205H690" fill="none" stroke="#d9d3c1" stroke-width="70"/><path d="M520 65V205H690" fill="none" stroke="#0d7182" stroke-width="8"/><path d="M535 82V185H665" fill="none" stroke="#f4b942" stroke-width="11"/><circle cx="555" cy="125" r="19" fill="#0d7182"/><text x="547" y="132" fill="white">🎣</text><text x="70" y="120">陸・施設側</text><text x="555" y="250">海側</text></svg>`},'ichihara':{title:'市原・海づり施設',note:'釣り場の形と水際を分かりやすくしたMFL簡易模式図。入口・施設・規制は現地の最新表示を優先。',legend:['黄色＝釣り可能水際の目安', '🎣＝狙いやすい側のイメージ', '現地掲示を最優先'],svg:`<svg viewBox="0 0 760 330"><rect width="760" height="330" rx="26" fill="#d8eef2"/><path d="M40 65H520V205H690" fill="none" stroke="#d9d3c1" stroke-width="70"/><path d="M520 65V205H690" fill="none" stroke="#0d7182" stroke-width="8"/><path d="M535 82V185H665" fill="none" stroke="#f4b942" stroke-width="11"/><circle cx="555" cy="125" r="19" fill="#0d7182"/><text x="547" y="132" fill="white">🎣</text><text x="70" y="120">陸・施設側</text><text x="555" y="250">海側</text></svg>`},'kisarazu_uchiko':{title:'木更津内港公園',note:'釣り場の形と水際を分かりやすくしたMFL簡易模式図。入口・施設・規制は現地の最新表示を優先。',legend:['黄色＝釣り可能水際の目安', '🎣＝狙いやすい側のイメージ', '現地掲示を最優先'],svg:`<svg viewBox="0 0 760 330"><rect width="760" height="330" rx="26" fill="#d8eef2"/><path d="M40 65H520V205H690" fill="none" stroke="#d9d3c1" stroke-width="70"/><path d="M520 65V205H690" fill="none" stroke="#0d7182" stroke-width="8"/><path d="M535 82V185H665" fill="none" stroke="#f4b942" stroke-width="11"/><circle cx="555" cy="125" r="19" fill="#0d7182"/><text x="547" y="132" fill="white">🎣</text><text x="70" y="120">陸・施設側</text><text x="555" y="250">海側</text></svg>`},'tateyama_sunset':{title:'館山夕日桟橋',note:'歩道側・先端部での釣りは禁止。2026年8月21日まで平日8:30〜17:00は歩道改修工事で一部立入禁止。',legend:['黄色＝釣り可能側', '赤点線＝歩道側・禁止', '先端部＝釣り禁止'],svg:`<svg viewBox="0 0 760 330"><rect width="760" height="330" rx="26" fill="#d8eef2"/><rect x="25" y="45" width="155" height="240" rx="18" fill="#d8d1bd"/><path d="M165 140H680" stroke="#fff" stroke-width="72"/><path d="M165 140H680" stroke="#0d7182" stroke-width="7"/><path d="M210 92H590" stroke="#f4b942" stroke-width="11"/><path d="M210 188H590" stroke="#df5c5c" stroke-width="11" stroke-dasharray="18 12"/><rect x="590" y="90" width="90" height="100" rx="12" fill="#f7d9d9"/><text x="235" y="74">釣り可能側</text><text x="235" y="222">歩道側：釣り禁止</text><text x="603" y="145">先端</text><text x="603" y="167">禁止</text></svg>`},'wakasu':{title:'若洲海浜公園',note:'釣り場の形と水際を分かりやすくしたMFL簡易模式図。入口・施設・規制は現地の最新表示を優先。',legend:['黄色＝釣り可能水際の目安', '🎣＝狙いやすい側のイメージ', '現地掲示を最優先'],svg:`<svg viewBox="0 0 760 330"><rect width="760" height="330" rx="26" fill="#d8eef2"/><path d="M40 65H520V205H690" fill="none" stroke="#d9d3c1" stroke-width="70"/><path d="M520 65V205H690" fill="none" stroke="#0d7182" stroke-width="8"/><path d="M535 82V185H665" fill="none" stroke="#f4b942" stroke-width="11"/><circle cx="555" cy="125" r="19" fill="#0d7182"/><text x="547" y="132" fill="white">🎣</text><text x="70" y="120">陸・施設側</text><text x="555" y="250">海側</text></svg>`}};

function seawallMapFor(s){
 const d=seawallMapData[s.id]; if(!d)return '';
 return `<section class="seawall-card"><div class="seawall-head"><div><small>🗺️ MFL SEAWALL MAP</small><h4>${d.title}</h4></div><span>簡易堤防地図</span></div><div class="seawall-svg">${d.svg}</div><div class="seawall-legend">${d.legend.map(x=>`<span>${x}</span>`).join('')}</div><p>${d.note}</p><div class="seawall-warning">⚠️ 測量図ではありません。現地掲示・立入規制・管理者の最新情報を最優先してください。</div></section>`;
}
