...
{id:'ichihara',area:'bay-east',name:'オリジナルメーカー海づり公園',short:'市原',pref:'千葉',beginner:5,tackle:'◎',x:61,y:61,address:'千葉県市原市五井南海岸1-12',fish:'アジ・サバ・スズキ・クロダイ・イワシなど',styles:['サビキ ◎','軽めのルアー ○','ジグヘッド ○','ちょい投げ ○'],facilities:['フェンス','監視員','トイレ','売店','貸竿','食堂','無料ライフジャケット（小学生以下）'],note:'足場と安全設備が整った桟橋型。4〜10月は6:00〜19:00、11〜3月は7:00〜17:00。桟橋利用終了は閉園30分前。',beginnerTip:'手ぶら利用と貸竿に対応。初回はサビキか軽いちょい投げから始め、監視員の案内を優先。',gear:'S90MLは軽め、100MHは少し重めを試しやすく、2本の性格差を楽しみやすい。',checked:'2026年8月30日',official:'https://ichihara-umizuri.com/guide/'},
...
{id:'kashima',area:'ibaraki',name:'鹿島港魚釣園',short:'鹿島',pref:'茨城',beginner:5,tackle:'◎',x:72,y:25,address:'茨城県鹿嶋市新浜11',fish:'アジ・サバ・イワシ・コノシロ・シロギス・カレイ・クロダイ・根魚・青物など',styles:['サビキ ◎','ルアー ○','ヘチ・探り釣り ○','ちょい投げ ○'],facilities:['安全柵','トイレ','売店','貸竿','無料駐車場','職員','救助設備'],note:'ライフジャケット着用必須。出し竿は1人2本まで。茨城県公式では鹿島港は魚釣園以外すべて釣り禁止。港湾施設・防波堤には絶対に入らない。',beginnerTip:'手ぶら利用が可能。回遊魚はサビキ、足元の根魚は探り釣りが始めやすい。毒棘魚を識別できない場合は素手で触らない。',gear:'水深3〜10mで釣り方の幅を出しやすく、S90MLと100MHの使い分け向き。',checked:'2026年8月30日',official:'https://kashima-fa.com/infomation/',discoverySource:'https://tokyoinnerbayfishing.net/%E8%8C%A8%E5%9F%8E%E7%9C%8C%E3%81%AE%E9%87%A3%E3%82%8A%E5%A0%B4/%E9%B9%BF%E5%B6%8B%E5%B8%82%E3%81%AE%E9%87%A3%E3%82%8A%E5%A0%B4/%E9%B9%BF%E5%B3%B6%E6%B8%AF%E9%AD%9A%E9%87%A3%E5%9C%92/'},
{id:'honmoku',area:'bay-south',name:'本牧海づり施設',short:'本牧',pref:'神奈川',beginner:5,tackle:'◎',x:42,y:70,address:'神奈川県横浜市中区本牧ふ頭1',fish:'アジ・サバ・イワシ・スズキ・クロダイなど',styles:['サビキ ◎','ルアー ○','ジグヘッド ○','ちょい投げ ○'],facilities:['管理施設','売店','食堂','貸竿','トイレ','駐車場'],note:'全長約1km・複数区画の大型管理施設。混雑時の場所取りは禁止され、荷物だけを置いた待機や代表者による複数人分の確保は不可。公式の当日営業・入場制限を確認。',beginnerTip:'売店・貸竿・食堂があり初回利用向き。混雑時は無理に人気区画へ入らず、係員の誘導に従う。',gear:'S90MLで軽め、100MHで重めを試し分けやすい。',checked:'2026年8月30日',official:'https://yokohama-fishingpiers.jp/honmoku/',discoverySource:'https://tokyoinnerbayfishing.net/kanagawa-ken/%E6%A8%AA%E6%B5%9C%E5%B8%82%E3%81%AE%E9%87%A3%E3%82%8A%E5%A0%B4/%E6%9C%AC%E7%89%A7%E6%B5%B7%E9%87%A3%E3%82%8A%E6%96%BD%E8%A8%AD/'},
...
function showFishingSpot(id,options={}){
  ...
  overlay.innerHTML=`
    <div class="fishing-spot-sheet" role="dialog" aria-modal="true" aria-label="${escapeHtml(s.name)}の詳細">
      ...
      ${!forecastOnly&&s.beginnerTip?`<section class="fishing-spot-section"><h4>🔰 初心者向け</h4><p>${escapeHtml(s.beginnerTip)}</p></section>`:''}
